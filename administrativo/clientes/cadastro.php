                                ...
                                <form action="processa-cadastro.php" method="POST">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="formControlCPF">CPF</label>
                                            <input type="number" class="form-control" id="formControlCPF" placeholder="Somente números">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="formControlEmail">E-mail</label>
                                            <input type="email" class="form-control" id="formControlEmail" placeholder="cliente@email.com">
                                        </div>
                                    </div>
